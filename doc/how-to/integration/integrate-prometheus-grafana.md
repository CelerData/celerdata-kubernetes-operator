---
title: Integrate with Prometheus and Grafana
sidebar_label: Prometheus and Grafana
sidebar_position: 2
description: Expose cluster metrics to Prometheus with pod annotations or a ServiceMonitor, then import the Grafana dashboard.
---

...
sidebar_label: Deploy Prometheus and Grafana
sidebar_position: 1
description: Install Prometheus and Grafana, either directly with Helm or via the Prometheus Operator.
---
...
the [Grafana Prometheus data source docs](https://grafana.com/docs/grafana/latest/datasources/prometheus/configure-prometheus-data-source/) for

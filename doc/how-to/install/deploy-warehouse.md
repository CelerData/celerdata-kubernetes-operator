---
title: Deploy a warehouse
sidebar_label: Deploy a warehouse
sidebar_position: 4
description: Create a CelerDataWarehouse alongside an existing cluster, with the CRD or with the warehouse chart.
---
...
2. An installed CelerData Cluster.
   See [deploy_celerdata_with_operator_howto.md](./deploy-with-operator.md)
   or [deploy_celerdata_with_helm_howto.md](./deploy-with-helm.md) for more details.
...
You can see [api.md](../../reference/api.md) for more details about the CelerDataWarehouse CRD fields. The spec part is very similar

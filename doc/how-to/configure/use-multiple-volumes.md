---
title: Use multiple volumes
sidebar_label: Use multiple volumes
sidebar_position: 2
description: Spread BE storage across several volumes with storage_root_path, including per-volume storage classes.
---
